class Spacecraft {
    ...
    drawSpacecraft2(characterData) {
        ...
        if (showGraphics && allImagesLoadedSuccessfully) {
            ...
            if (myCharacterData.canCloake && this.isCloaked) {
                if (myCharacterData.imageId === 7) {
                    if (this.team === 'blue') {
                        image(cloakedPurpleSpacecraft7Image, 0, 0, diameter * 1.5, diameter * 1.2);
                    } else {
                        image(cloakedGreenSpacecraft7Image, 0, 0, diameter * 1.5, diameter * 1.2);
                    }
                } else {
                    if (this.team === 'blue') {
                        image(cloakedPurpleSpacecraft10Image, 0, 0, diameter * 1.5, diameter * 1.2);
                    } else {
                        image(cloakedGreenSpacecraft10Image, 0, 0, diameter * 1.5, diameter * 1.2);
                    }
                }
            } else {
        ...
        let hitsRemaining = 10 - hitByOthers;
        ...
        if (!this.isCloaked) {
            ...
            let fillWidth = map(hitsRemaining, 0, 10, 0, barWidth);
